        ...
        <div style={{
          ...
          {error && (
            <div style={{
              ...
              color: 'var(--red)', marginBottom: '1.25rem',
            }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              <label style={{ display: 'block', fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 6 }}>
                Email
              </label>
              <input
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                <label style={{ fontFamily: 'var(--font-mono)', fontSize: 9, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>
                  Password
                </label>
                <Link href="/auth/reset-password" style={{ fontSize: 11, color: 'var(--accent2)', textDecoration: 'none' }}>
                  Forgot?
                </Link>
              </div>
              <input
          ...
          <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: 12, color: 'var(--text-muted)' }}>
            ...
            <Link href="/auth/signup" style={{ color: 'var(--accent2)', textDecoration: 'none' }}>
              Sign up
            </Link>
          </p>
        </div>
