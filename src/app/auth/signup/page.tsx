    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ textAlign: 'center', maxWidth: 400 }}>
          <div style={{ fontFamily: 'var(--font-bebas)', fontSize: 32, letterSpacing: '0.1em', color: 'var(--green)', marginBottom: 12 }}>
            Check Your Email
          </div>
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-default)', borderRadius: 12, padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              ...
              <div key={label}>
                ...
                <input
                  type={type} autoComplete={auto} required
          ...
          <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: 12, color: 'var(--text-muted)' }}>
            ...
            <Link href="/auth/login" style={{ color: 'var(--accent2)', textDecoration: 'none' }}>
              Sign in
            </Link>
          </p>
        </div>
